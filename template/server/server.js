...
<head>
  ...
  <style>
    ...
    .result-card:hover { transform: translateY(-4px); box-shadow: 0 10px 30px -10px rgba(249, 115, 22, 0.3); }
  </style>
</head>
<body>
...
<script>
  ...
  function renderResults(data) {
    ...
    grid.innerHTML = data.map(item => \`
      <a href="\${esc(item.slug)}" class="result-card bg-zinc-900 rounded-lg overflow-hidden shadow-lg border border-zinc-800 hover:border-orange-500 transition">
        <div class="relative">
